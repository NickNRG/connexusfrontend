...
App = function () {
  function App() {_classCallCheck(this, App);
  ...
  }_createClass(App, [{ key: 'start', value: function start()
    {
      ...
      this.splitText();
    } }, { key: 'splitText', value: function splitText()
    {
    ...
    } }, { key: 'animateText', value: function animateText()
    {
      ...
      ui.textNodes.forEach(function (el, elIndex) {
        ...
        var length = Math.round(letters.length / 2) + 1;var _loop = function _loop(
        i) {var _ref =
          [letters[i], letters[letters.length - i]],letter1 = _ref[0],letter2 = _ref[1];
          setTimeout(function () {
    ...
    } }, { key: 'updateTextConfig', value: function updateTextConfig()
    {
      var state = this.state;
      state.text = {
        baseLine: 'top',
        font: '800 10vh Montserrat',
        value: '' };

    } }, { key: 'initCheckingInterval', value: function initCheckingInterval()
    {
      var state = this.state;
    ...
    } }, { key: 'getTextPixels', value: function getTextPixels()
    {
      var ctx = context.main;
      var state = this.state;var
      xCell = plane.xCell,yCell = plane.yCell;
    ...
    {var
      ...
      i) {
        var pixel = state.textPixelData[i];var
        x = pixel.x,y = pixel.y,value = pixel.value;
        ...
        });};for (var i = 0; i < state.textPixelData.length; i++) {_loop2(i);
      }
    ...
    } }, { key: 'draw', value: function draw()
    {
      ...
      plane.xCell,yCell = plane.yCell,xCenter = plane.xCenter,yCenter = plane.yCenter,cells = plane.cells;
      ...
      for (var i = 0; i < cells[0]; i++) {
        for (var i2 = 0; i2 < cells[1]; i2++) {
          ...
          if (state.planeIsDrawn) {
            this.drawMouseMoveInteraction({ i: i, i2: i2, x: _x, y: _y });
            if (i2 === xCenter && i !== yCenter) {
              this.drawMarkupYAnimation({ i: i, i2: i2, x: _x, y: _y, cp: cp });
            }
            if (i2 !== xCenter && i === yCenter) {
              this.drawMarkupXAnimation({ i: i, i2: i2, x: _x, y: _y, cp: cp });
            }
          }
    ...
    } }, { key: 'startGeneratingNumbers', value: function startGeneratingNumbers()
    {
      var state = this.state;
      function generateItem() {var
        cells = plane.cells,xCell = plane.xCell,yCell = plane.yCell;
      ...
      generateItem();
    } }, { key: 'drawNumbersAnimation', value: function drawNumbersAnimation()
    {
      var ctx = context.main;
      var state = this.state;var
    ...
    } }, { key: 'startGeneratingLines', value: function startGeneratingLines()
    {
      var state = this.state;
      function generateItem() {var
        cells = plane.cells,xCell = plane.xCell,yCell = plane.yCell;
      ...
      generateItem();
    } }, { key: 'drawAnimLines', value: function drawAnimLines()
    {
      var ctx = context.main;
      var state = this.state;
    ...
    } }, { key: 'startGeneratingGlitches', value: function startGeneratingGlitches()
    {
      var state = this.state;
      function generateItem() {var
        cells = plane.cells,xCell = plane.xCell,yCell = plane.yCell;
      ...
      generateItem();
    } }, { key: 'drawGlitches', value: function drawGlitches()
    {
      var ctx = context.main;
      var state = this.state;
    ...
    } }, { key: 'drawMouseMoveInteraction', value: function drawMouseMoveInteraction(
    props) {
      var ctx = context.main;
      var state = this.state;
      var fp = state.fadeInProgress;
      var sp = state.stepOffset;
      var mp = state.mousePower;var

      xCenter =

      plane.xCenter,yCenter = plane.yCenter;var
      i = props.i,i2 = props.i2,x = props.x,y = props.y;
    ...
    } }, { key: 'drawPlaneDotsAnimation', value: function drawPlaneDotsAnimation(
    props) {
      var ctx = context.plane;var
      dp = props.dp,i = props.i,i2 = props.i2,x = props.x,y = props.y;var

      xCenter =

      plane.xCenter,yCenter = plane.yCenter;
      var position = [Math.abs(i2 - xCenter), Math.abs(i - yCenter)];
    ...
    } }, { key: 'drawPlaneCenterLines', value: function drawPlaneCenterLines(
    props) {var
      p = props.p;
      var ctx = context.plane;var
    ...
    } }, { key: 'drawYLines', value: function drawYLines(
    props) {var
      i = props.i,cp = props.cp,p = props.p,x = props.x;
      var ctx = context.plane;var
    ...
    } }, { key: 'drawYMarkup', value: function drawYMarkup(
    props) {
      var ctx = context.plane;
      var state = this.state;var
      i = props.i,p = props.p,cp = props.cp,x = props.x,y = props.y;var
    ...
    } }, { key: 'drawXLines', value: function drawXLines(
    props) {
      var ctx = context.plane;var
      i2 = props.i2,cp = props.cp,p = props.p,y = props.y;var
    ...
    } }, { key: 'drawXMarkup', value: function drawXMarkup(
    props) {
      var ctx = context.plane;
      var state = this.state;var
      i2 = props.i2,p = props.p,cp = props.cp,x = props.x,y = props.y;var
    ...
    } }, { key: 'drawPlane', value: function drawPlane()
    {
      ...
      ctx.clearRect(0, 0, doc.width, doc.height);var
      ...
      for (var i = 0; i < cells[0]; i++) {
        for (var i2 = 0; i2 < cells[1]; i2++) {
          ...
          if (i2 !== xCenter && i === yCenter) {
            ...
            this.drawXMarkup({ i2: i2, p: p, cp: cp, x: _x2, y: _y2 });
          }
        }
      }

    } }, { key: 'drawMarkupYAnimation', value: function drawMarkupYAnimation(
    props) {

      var ctx = context.main;var

      yCenter =
      plane.yCenter;var
      i = props.i,x = props.x,y = props.y;
    ...
    } }, { key: 'drawMarkupXAnimation', value: function drawMarkupXAnimation(
    props) {

      var ctx = context.main;
      var state = this.state;var
      i2 = props.i2,x = props.x,y = props.y;
      var spSin = Math.sin(state.markupOffset);
      var sp = spSin <= 0 ? tools.cellEasing(Math.abs(spSin), 0, 1, 1) : 0;var
